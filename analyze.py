...
def analyze(data):
    ...
    return_on_equity = data['zestimates']['rent_zestimate']/(data['zestimates']['zestimate'] - data['monthly_mortgage']['down_payment'])

    #data['zestimates']['rent_zestimate']
    #data['zestimates']['zestimate']
    #data['taxes']['tax_amt_mn']
    #data['pi']['monthly']
    #data['fi']['monthly']
    #data['pmi']['monthly']
    #data['pm']['amount']
    ...
    #data['monthly_mortgage']['down_payment']
    #data['closing_costs']['closing_costs']
    #data['rehab_costs']
